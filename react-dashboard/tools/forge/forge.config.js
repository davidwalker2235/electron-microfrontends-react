  ...
  plugins: [
    {
      ...
      config: {
        ...
        devContentSecurityPolicy: `default-src 'self' 'unsafe-inline' data:; script-src 'self' http://localhost:8080 'unsafe-inline' data:;connect-src https://cat-fact.herokuapp.com 'unsafe-inline'`,
        // Ports
